...
CREATE TABLE `pe_coach`  (
  ...
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '教练手机',
...
-- Records of pe_coach
-- ----------------------------
INSERT INTO `pe_coach` VALUES (6, '小杨', 16, '金彦舞蹈(经开店)', '员工', 1, 'cs001', '13311111111', 1, 0, '杨舞师', '', 1, 3);
INSERT INTO `pe_coach` VALUES (7, '小梁', 17, '金彦舞蹈(经开店)', '员工', 0, 'cs002', '13322222222', 1, 0, '梁舞师', '', 1, 4);
INSERT INTO `pe_coach` VALUES (8, '大鹏', 18, '金彦舞蹈(经开店)', '员工', 1, 'cs003', '13333333333', 1, 0, '鹏舞师', '', 1, 2);
INSERT INTO `pe_coach` VALUES (9, '小张', 19, '金彦舞蹈(经开店)', '员工', 0, 'cs004', '13366666666', 1, 0, '张舞师', '', 0, 5);
...
CREATE TABLE `pe_contract_paytype`  (
  ...
  `paytype_id` int(11) DEFAULT NULL COMMENT '付款方式ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户会员卡付款方式表' ROW_FORMAT = Dynamic;
...
-- ----------------------------
INSERT INTO `pe_office` VALUES (7, 6, 4, '2020-04-01', '2020-04-30');
...
CREATE TABLE `pe_order`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 41 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车临时表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 824 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_login_log`  (
  ...
  `create_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 418 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_permission`  (
  ...
  `create_time` datetime(0) DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 785 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统权限' ROW_FORMAT = Dynamic;
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (6, ',7,733,734,735,736,737,738,739,740,71,710,711,712,72,720,721,722,73,730,731,732,74,75,76,4,777,778,779,780,781,782,783,784,741,742,743,744,745,746,752,753,748,749,750,751,1,11,12,120,121,122,13,130,131,132,14,140,3,31,310,311,312,32,320,321,322,323,324,33,756,757,758,759,760,761,762,775,763,764,765,766,767,768,776,769,770,771,772,773,774,2,5,6,', 1, '超级管理员', '1', '2020-01-13 19:49:32', '2019-12-23 14:58:32');
