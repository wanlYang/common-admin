...
public class MessageUtil {
    ...
    static final String accessKeyId = "LTAIoGvBcuxgSSdr";  // TODO 修改成自己的
    static final String accessKeySecret = "wwwZ7PHDtvTWR0GDniS2uBirOMYj2e";   // TODO 修改成自己的
    ...
    public static SendSmsResponse sendSms(String phone, int code) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("新晔舞蹈");    // TODO 修改成自己的
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_146803145");    // TODO 修改成自己的
...
//        request.setTemplateParam("{\"name\":\"Tom\", \"code\":\"123\"}");
    ...
    public static void sendSmsM(String name, String phone) throws ClientException {
        //可自助调整超时时间
        System.setProperty("sun.net.client.defaultConnectTimeout", "6000");
        System.setProperty("sun.net.client.defaultReadTimeout", "6000");
        //初始化acsClient,暂不支持region化
        ...
        request.setSignName("新晔舞蹈");    // TODO 修改成自己的
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_181191382");    // TODO 修改成自己的
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
//        request.setTemplateParam("{\"name\":\"Tom\", \"code\":\"123\"}");
...
*/
    ...
    public static int getNewcode() {
        int newcode = (int)(Math.random()*999999)+100;   //每次调用生成一位四位数的随机数
        return newcode;
    }
