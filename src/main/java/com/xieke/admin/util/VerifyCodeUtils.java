...
public class VerifyCodeUtils {
    ...
    public static void outputImage(int w, int h, OutputStream os, String code) throws IOException {
        ...
        Color[] colorSpaces = { Color.WHITE, Color.CYAN, Color.GRAY, Color.LIGHT_GRAY, Color.MAGENTA, Color.ORANGE,
        ...
        for (int i = 0; i < verifySize; i++) {
            ...
            affine.setToRotation(0.7853981633974483D * rand.nextDouble() * (rand.nextBoolean() ? 1 : -1),
