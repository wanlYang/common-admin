...
CREATE TABLE `co_table_cources`  (
  ...
  `coach_id` int(11) NULL DEFAULT NULL COMMENT '上课教练          外键',
...
INSERT INTO `co_table_cources` VALUES ('38917510421574752465651', NULL, NULL, '★', NULL, NULL, '12:30:00', '13:30:00', '47196108431574247199561', '10132947561574263774261');
...
CREATE TABLE `jy_clubcard_paytype`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户会员卡付款方式表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jy_coupons`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '优惠券\r\n' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jy_customer`  (
  ...
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户资料表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `jy_setwinner`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '本表是设定中奖人表' ROW_FORMAT = Dynamic;
...
-- Records of pe_coach
-- ----------------------------
INSERT INTO `pe_coach` VALUES (5, '杨彬', 1, '金彦舞蹈(经开店)', '员工', 0, 'jl1001', '18802927580', 1, 0, '测试1', '测试1', 0);
...
-- ----------------------------
INSERT INTO `pe_coach_dance` VALUES (6, 6, 5);
...
-- ----------------------------
INSERT INTO `pe_contract` VALUES (6, 'SJ20201105763109842', 11, 0, 6, 5, 6, '60', 1, 100.00, 10, 0, 10, 1000.00, 0.00, 1000.00, '2020-01-10', '2020-01-31', '2020-01-10', '测试合同1', '1212', '0', '金彦舞蹈(经开店)', 1, 0, 0, 10, 1, '2020-01-10 16:02:44', 1, '2020-01-10 20:55:05', 1000.00);
...
CREATE TABLE `pe_contract_paytype`  (
  ...
  `paytype_id` int(11) NULL DEFAULT NULL COMMENT '付款方式ID',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 24 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '客户会员卡付款方式表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `pe_office`  (
  ...
  CONSTRAINT `officetime_id` FOREIGN KEY (`officetime_id`) REFERENCES `pe_coach` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `pe_officetime` VALUES (4, '晚班', '13:20:00', '21:30:00', '#a541c4', 1);
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 789 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_login_log`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 379 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '登录日志' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_permission`  (
  ...
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 776 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统权限' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role`  (
  `id` int(10) NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `permission_ids` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '权限ID列表',
  `available` tinyint(1) NULL DEFAULT NULL COMMENT '是否可用',
